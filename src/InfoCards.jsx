...
const infoText= {
    ...
    card_3_info: "Nuestro navegador privado para móviles viene equipado con nuestro motor de búsqueda," +
...
const InfoCards = () => (
  <div className="info_cards_cont">
    <Card img="src/assets/laptop.svg" title="Privacidad para Chrome" info={infoText.card_1_info}/>
    <Card img="src/assets/search.svg" title="Motor de Búsqueda Privada" info={infoText.card_2_info}/>
    <Card img="src/assets/mobile.svg" title="Navegador Privado" info={infoText.card_3_info}/>
  </div>
)
